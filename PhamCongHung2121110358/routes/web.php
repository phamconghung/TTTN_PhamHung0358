...
Route::get('slider/trash', [SliderController::class, 'trash'])->name('slider.trash');
    ...
    Route::prefix('banner')->group(function () {
        ...
        Route::post('trash_multi', [BannerController::class, 'trash_multi'])->name('banner.trash_multi');
        Route::post('delete_multi', [BannerController::class, 'delete_multi'])->name('banner.delete_multi');
    });   
    //////////
