...
<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Default box -->
        <form action="{{ route('banner.delete_multi') }}" name="form1" method="post"  >
            @csrf
            <!-- Default box -->
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <div class="text-right">
                                ...
                                <a class="btn btn-sm btn-danger" href="{{ route('banner.trash') }}">
                           ...
                           @foreach ($banner as $row)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    href="{{ route('banner.status',['banner'=> $row->id]) }}">
                                    ...
                                    <a class="btn btn-sm btn-info"
                                        href="{{ route('banner.show',['banner'=> $row->id]) }}">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a class="btn btn-sm btn-primary"
                                        href="{{ route('banner.edit',['banner'=> $row->id]) }}">
                                        <i class=" fas fa-edit"></i>
                                    </a>
                                    <a class="btn btn-sm btn-danger"
                                        href="{{ route('banner.delete',['banner'=> $row->id]) }}">
