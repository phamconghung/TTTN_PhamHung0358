...
@section('content')
    <section class="content">
        <div class="content-wrapper">
            ...
            <!-- Main content -->
            <section class="content">
                <form action="{{ route('banner.store') }}" name="form1" method="post" enctype="multipart/form-data">
                    <!-- Default box --> @csrf
                    <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="position" id="position"  class="form-control">
                                            <option value="bannershow">bannershow</option>
                                            <option value="bannershowend">bannershowend</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
